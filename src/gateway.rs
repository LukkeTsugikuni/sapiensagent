...
</style><style>.chat-history{display:grid;gap:10px;max-height:480px;overflow:auto;padding:4px 2px}.chat-message{display:grid;gap:5px;max-width:86%;padding:11px 13px;border:1px solid var(--line);border-radius:12px;line-height:1.6;white-space:pre-wrap}.chat-message.user{justify-self:end;background:#12302b;border-color:#2d6b5d}.chat-message.assistant{justify-self:start;background:#0d1417}.chat-message.system{justify-self:center;color:var(--muted);font-size:12px}.chat-role{font-size:10px;letter-spacing:.1em;text-transform:uppercase;color:var(--accent);font-weight:800}.chat-empty{color:var(--muted);padding:24px 8px;text-align:center}</style>
<style id="sapiens-operator-theme">
:root{--bg:#07111f;--surface:#0d1a2b;--surface2:#11243a;--surface3:#172d47;--line:#23415f;--text:#eef6ff;--muted:#91a8bf;--accent:#63e6f2;--accent2:#a78bfa;--good:#5eead4;--warn:#f6c76d;--bad:#fb7185;--shadow:0 24px 70px #020817b8}
body{background:radial-gradient(circle at 84% -12%,#1b3b5c 0,#0b1830 31%,var(--bg) 66%);letter-spacing:.005em}
body:before{content:"";position:fixed;inset:0;pointer-events:none;opacity:.2;background-image:linear-gradient(#7dd3fc08 1px,transparent 1px),linear-gradient(90deg,#7dd3fc08 1px,transparent 1px);background-size:42px 42px;mask-image:linear-gradient(to bottom,black,transparent 72%)}
.shell{grid-template-columns:272px 1fr;position:relative}.rail{position:sticky;top:0;height:100vh;display:flex;flex-direction:column;overflow-y:auto;padding:27px 17px;background:linear-gradient(180deg,#091525f2,#07111fe8);border-right:1px solid #23415fb8;box-shadow:18px 0 50px #02081733}.brand{margin:2px 8px 34px}.mark{width:40px;height:40px;border:1px solid var(--accent);background:linear-gradient(145deg,#123950,#20184d);color:#e6fbff;box-shadow:0 0 28px #63e6f233}.brand strong{color:#f6fbff;letter-spacing:.16em}.brand small{color:#8ca9c4}.nav{gap:6px}.nav button{min-height:42px;border-radius:12px;padding:10px 13px;transition:background .18s ease,border-color .18s ease,transform .18s ease}.nav button:hover{background:#122944;border-color:#285174;transform:translateX(2px)}.nav button.active{background:linear-gradient(100deg,#153854,#1b2d50);border-color:#386184;box-shadow:inset 3px 0 var(--accent),0 8px 20px #02081744;color:#fff}.nav button.active .icon,.nav button:hover .icon{color:var(--accent)}.nav .icon{color:#72b9ce}.rail-foot{position:static;width:auto;margin-top:auto;padding:20px 8px 0;color:#7892ab}
.content{max-width:1480px;padding:34px clamp(20px,4vw,64px) 56px}.top{padding-bottom:22px;margin-bottom:22px;border-bottom:1px solid #1e3852}.eyebrow{color:var(--accent);font-size:10px;letter-spacing:.18em}.top h1{font-size:34px;line-height:1.1;color:#f6fbff}.top .muted{color:#9db4cb}.pill{background:#0c292a;border-color:#286b70;color:var(--good);box-shadow:0 0 20px #5eead41a}.pill.bad{background:#321727;border-color:#7c344d}
.grid{gap:16px}.card{position:relative;overflow:hidden;background:linear-gradient(145deg,#10233af2,#0b1728f5);border-color:#23415f;box-shadow:var(--shadow);border-radius:16px;padding:20px}.card:before{content:"";position:absolute;inset:0 0 auto;height:1px;background:linear-gradient(90deg,transparent,var(--accent),var(--accent2),transparent);opacity:.6}.card h2{font-size:17px;color:#f4f9ff}.card h3{color:#dceaff}.label{color:#86a3be;letter-spacing:.1em}.metric{font-size:28px;color:#f4fbff;letter-spacing:-.03em}.section{margin-top:16px}.row{border-bottom-color:#1e3852;padding:11px 0}.tag{background:#0c1b2c;border-color:#294964;padding:5px 9px}.on{color:var(--good)}.off{color:var(--warn)}.provider{padding:17px 0;border-bottom-color:#1e3852}.provider-meta{gap:8px}.provider-actions{gap:8px}.catalog{gap:12px}.channel{padding:15px;border-color:#294964;background:linear-gradient(145deg,#10243a,#0d1b2c);border-radius:13px;transition:transform .18s ease,border-color .18s ease}.channel:hover{transform:translateY(-2px);border-color:#3b6d91}.notice{border-left-color:var(--accent);background:linear-gradient(100deg,#103447,#132644);color:#d6f3f7;border-radius:0 12px 12px 0}.result,textarea,input,select{background:#081524e8;border-color:#294964;color:var(--text)}textarea:focus,input:focus,select:focus{border-color:var(--accent);box-shadow:0 0 0 3px #63e6f226}.primary{background:linear-gradient(135deg,var(--accent),#7dd3fc);color:#06121c;box-shadow:0 8px 20px #38bdf833}.primary:hover{background:linear-gradient(135deg,#b5f7fb,#c4b5fd);transform:translateY(-1px)}.secondary{border-color:#335572;background:#0e2034;color:#e4effa}.secondary:hover{background:#173653;border-color:#4a7597}.danger{border-color:#8b3f57;background:#261424}.toast{background:#11243aeb;border-color:#3a607f;backdrop-filter:blur(14px)}
.chat-box{min-height:calc(100vh - 185px);align-content:start}.chat-head{padding-bottom:12px;border-bottom:1px solid #1e3852}.chat-head h2{font-size:21px}.chat-history{min-height:280px;max-height:calc(100vh - 470px);padding:18px;border:1px solid #203e5b;border-radius:15px;background:linear-gradient(180deg,#091729cc,#0b1929aa);box-shadow:inset 0 1px #6ee7f11a}.chat-message{max-width:min(78%,720px);padding:13px 16px;border-radius:15px;border-color:#294964;background:#10243a}.chat-message.user{background:linear-gradient(135deg,#5fe2e9,#7dd3fc);border-color:#8af4f5;color:#06131e;box-shadow:0 8px 22px #38bdf82b}.chat-message.user .chat-role{color:#0a3845}.chat-message.assistant{background:linear-gradient(145deg,#112640,#0d1c30);border-color:#2d5475}.chat-message.system{max-width:92%;background:#241c24;border-color:#6a4b4c;color:#f1caca}.chat-role{color:var(--accent);letter-spacing:.13em}.chat-empty{padding:48px 12px;color:#7995ad}.chat-selectors{padding:10px;border:1px solid #294964;border-radius:13px;background:#0b1a2d}.chat-selectors select{background:#102640}
@media(max-width:760px){.shell{grid-template-columns:1fr}.rail{position:relative;height:auto;max-height:none;overflow:visible}.content{padding:23px 14px 38px}.top h1{font-size:29px}.chat-box{min-height:0}.chat-history{max-height:55vh}.chat-message{max-width:92%}}
</style></head>
